...
export function GeneralPanel({ className = '' }: GeneralPanelProps) {
  ...
  return (
    <div className={`w-full md:w-64 ${className}`}>
      <aside className="surface-shadow relative w-full overflow-hidden rounded-[16px] border border-black/5 bg-transparent p-6 backdrop-blur-[14px] transition-all duration-300 hover:-translate-y-1.5">
