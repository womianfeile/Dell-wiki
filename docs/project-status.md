...
| Chromium 毛玻璃闪烁调查 | 层级调整已保留，问题仍未解决并暂时搁置 | 是 | 是 | 否 |

本地实现、Git 提交、push 和 GitHub Pages 部署是四个独立状态。2026-07-31 的首页毛玻璃层级调整与移动端拖拽收窄已提交并推送到 `main`，但尚未重新部署到 GitHub Pages；线上仍是 2026-07-14 验证过的部署版本。
...
2026-07-31 已确认远端 `main` 与本地一致。GitHub Pages 本轮未重新部署；线上地址 <https://womianfeile.github.io/Dell-wiki/> 仍对应 2026-07-14 验证过的版本。
